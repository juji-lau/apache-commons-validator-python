...
class ValidatorResults:
    ...
    def add(self, field, validator_name, result, value=None):
        """
        Add the result of a validator action.

        Args:
            field: The field validated. Expected to have a method get_key() or an attribute 'key'.
        ...
        key = field.get_key() if hasattr(field, "get_key") else field.key
