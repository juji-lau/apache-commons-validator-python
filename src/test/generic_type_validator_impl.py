...
class GenericTypeValidatorImpl:
    ...
    def validate_byte(bean: object, field, locale: Optional[str] = None) -> bool:
        ...
        return (
            GenericTypeValidator.format_byte(value, locale)
            if locale
            else GenericTypeValidator.format_byte(value)
        )
    ...
    def validate_double(bean: object, field, locale: Optional[str] = None) -> bool:
        value = ValidatorUtils.get_value_as_string(bean, field.get_property())
        return (
            GenericTypeValidator.format_double(value, locale)
            if locale
            else GenericTypeValidator.format_double(value)
        )
    ...
    def validate_float(bean: object, field, locale: Optional[str] = None) -> bool:
        value = ValidatorUtils.get_value_as_string(bean, field.get_property())
        return (
            GenericTypeValidator.format_float(value, locale)
            if locale
            else GenericTypeValidator.format_float(value)
        )
    ...
    def validate_int(bean: object, field, locale: Optional[str] = None) -> bool:
        value = ValidatorUtils.get_value_as_string(bean, field.get_property())
        return (
            GenericTypeValidator.format_int(value, locale)
            if locale
            else GenericTypeValidator.format_int(value)
        )
    ...
    def validate_long(bean: object, field, locale: Optional[str] = None) -> bool:
        value = ValidatorUtils.get_value_as_string(bean, field.get_property())
        return (
            GenericTypeValidator.format_long(value, locale)
            if locale
            else GenericTypeValidator.format_long(value)
        )
    ...
    def validate_short(bean: object, field, locale: Optional[str] = None) -> bool:
        value = ValidatorUtils.get_value_as_string(bean, field.get_property())
        return (
            GenericTypeValidator.format_short(value, locale)
            if locale
            else GenericTypeValidator.format_short(value)
        )
