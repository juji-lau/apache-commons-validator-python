...
class Form:
    """
    This contains a set of validation rules for a form. The information is
    ...
    def processed(self) -> bool:
        """
        Checks whether the form has been processed. (translation of isProcessed())
    ...
    def _merge(self, depends: "Form") -> None:
        ...
        not present in this form, include it. `depends` has precedence in the
        way the fields are ordered.
