...
class DomainValidator:
    """
    Domain name</strong> validation routines.</p>
    ...
    class ArrayType(Enum):
        """
        enum used by updateTLDOverride(ArrayType, String[]) to determine which override array to update / fetch
        """
    ...
    __INFRASTRUCTURE_TLDS: Final[list] = [
        "arpa"     # internet infrastructure
    ]

    __GENERIC_TLDS: Final[list] = [
...
#        "zippo", # zippo Zadco Company
    ...
    __COUNTRY_CODE_TLDS: Final[list] = [
...
#        "tp",                 # East Timor (Retired)
    ...
    def get_tld_entries(table: ArrayType):
        ...
        :return: A copy of the array. Throws a ValueError if the table type is unexpected (should not happen).
        """
    ...
    def update_tld_override(table: ArrayType, tlds: list[str]):
        ...
        :param table: The table to update, see ArrayType. Must be one of the following:
            ...
            <li>LOCAL_MINUS</li>
            <li>LOCAL_PLUS</li>
        :param tlds: The array of TLDs, must not be None.
    ...
    def get_overrides(self, table: ArrayType):
        ...
        :return: A copy of the array. Throws a ValueError if the table type is unexpected, for example, GENERIC_RO.
        """
    ...
    def is_valid(self, domain: str):
        ...
        return self.__allow_local and self.__hostname_regex.is_valid(domain)
    ...
    def is_valid_tld(self, tld: str):
        ...
        """
        if self.__allow_local and self.is_valid_local_tld(tld):
            return True
