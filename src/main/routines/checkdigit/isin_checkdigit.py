...
from src.main.routines.checkdigit.modulus_checkdigit import ModulusCheckDigit, CheckDigitException
...
class ISINCheckDigit(ModulusCheckDigit):
    ...
    def _calculate_modulus(self, code: str, includes_check_digit: bool) -> int:
        """
        Calculates the modulus for the given ISIN code after transforming characters to digits.
