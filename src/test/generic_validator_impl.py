...
from src.main import generic_type_validator, generic_validator, validator_exception
...
class GenericValidatorImpl:
    ...
    def validate_byte(bean: object, field) -> bool:
        ...
        return generic_validator.is_byte(value)
    ...
    def validate_double(bean: object, field) -> bool:
        ...
        """
        value = ValidatorUtils.get_value_as_string(bean, field.get_property())
        return generic_validator.is_double(value)
    ...
    def validate_email(bean: object, field) -> bool:
        ...
        """
        value = ValidatorUtils.get_value_as_string(bean, field.get_property())
        return generic_validator.is_email(value)
    ...
    def validate_float(bean: object, field) -> bool:
        ...
        """
        value = ValidatorUtils.get_value_as_string(bean, field.get_property())
        return generic_validator.is_float(value)
    ...
    def validate_int(bean: object, field) -> bool:
        ...
        """
        value = ValidatorUtils.get_value_as_string(bean, field.get_property())
        return generic_validator.is_int(value)
    ...
    def validate_long(bean: object, field) -> bool:
        ...
        """
        value = ValidatorUtils.get_value_as_string(bean, field.get_property())
        return generic_validator.is_long(value)
    ...
    def validate_positive(bean: object, field) -> bool:
        ...
        """
        value = ValidatorUtils.get_value_as_string(bean, field.get_property())
        return generic_type_validator.format_int(value) > 0
    ...
    def validate_raise_exception(bean: object, field) -> bool:
        ...
        raise validator_exception("VALIDATOR-EXCEPTION")
    ...
    def validate_required(bean: object, field) -> bool:
        ...
        """
        value = ValidatorUtils.get_value_as_string(bean, field.get_property())
        return not generic_validator.is_blank_or_null(value)
    ...
    def validate_required_if(bean: object, field, validator) -> bool:
        ...
        if not generic_validator.is_blank_or_null(field.get_var_value("fieldJoin")):
        ...
        while not generic_validator.is_blank_or_null(field.get_var_value(f"field[{i}]")):
    ...
    def validate_short(bean: object, field) -> bool:
        ...
        """
        value = ValidatorUtils.get_value_as_string(bean, field.get_property())
        return generic_validator.is_short(value)
