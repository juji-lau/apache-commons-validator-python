...
class AbstractFormatValidator(ABC):
    ...
    def _get_format(self, pattern: str=None, locale: str=None):
        ...
        :param pattern: The regex pattern used to validate the value against or None to
            use the default for the locale.
    ...
    def is_valid(self, value: str, pattern: str=None, locale: str=None):
        ...
        :param locale: The (optional) locale to use for the format, defaults to the
            system default.
