...
class Field:
    ...
    def dependency_list(self) -> List[str]:
        """
        Gets an copy (so it is unmodifiable) list of the dependencies in the same order
        they were defined in the parameter passed to depends.
    ...
    def indexed_list_property(self) -> str | None:
        ...
        (translation of getIndexedListProperty())
    ...
    def is_indexed(self) -> bool:
        """
        If there is a value specified for the __indexed_property field then
    ...
    def process(
        ...
        """
        Replace the constants with values in fields and process the depends
        field to create the dependency dict.
    ...
    def client_validation(self, client_va: bool) -> None:
        ...
        (translation of setClientValidation())
